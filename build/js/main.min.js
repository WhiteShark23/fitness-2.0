...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    document.querySelectorAll('[data-video]').forEach(_ininVideo.initVideos);
...
},{"./modules/accordions/init-accordion":3,"./modules/form-validate/form":5,"./modules/inin-video":11,"./modules/init-swiper":12,"./modules/tabs/init-tabs":13,"./utils/ios-vh-fix":16}],2:[function(require,module,exports){
"use strict";
...
},{"../utils/load-script.js":17}],12:[function(require,module,exports){
"use strict";

...
var _ininVideo = require("./modules/inin-video.js");
// ---------------------------------
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0, _ininVideo.initVideos)();
  (0, _iosVhFix.iosVhFix)();
  (0, _initTabs.initTabs)();
  (0, _initSwiper.initSwiperFirst)();
  (0, _initSwiper.initSwiperLast)();
...
},{"./modules/form-validate/form":4,"./modules/inin-video.js":10,"./modules/init-accordion.js":11,"./modules/init-swiper.js":12,"./modules/init-tabs.js":13,"./modules/modals/init-modals":14,"./utils/ios-vh-fix":19}],3:[function(require,module,exports){
"use strict";
...
},{"../utils/load-script.js":20}],11:[function(require,module,exports){
"use strict";
...
},{"../accordions":1}],12:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initSwiperLast = exports.initSwiperFirst = void 0;
var initSwiperFirst = function initSwiperFirst() {
  var swiperFirst = new window.Swiper('.swiper-first', {
    breakpoints: {
      320: {
        slidesPerView: 1,
        spaceBetween: 20
...
exports.initSwiperFirst = initSwiperFirst;
var initSwiperLast = function initSwiperLast() {
  var swiperLast = new window.Swiper('.swiper-last', {
    navigation: {
      nextEl: '.swiper-button-next',
      prevEl: '.swiper-button-prev'
    }
...
exports.initSwiperLast = initSwiperLast;
...
},{"../../utils/focus-lock":17,"../../utils/scroll-lock":21}],16:[function(require,module,exports){
"use strict";
